...
module.exports = msgHandler = async (client, message) => {
    try {
        ...
        const apiKey = 'AIzaSyBt3rlNqZm8vr69Ii01RM4l7StPns0omKI' // apikey you can get it at https://mhankbarbar.moe
        ...
        const ownerNumber = ["+201550123077"] // replace with your whatsapp number
        const isOwner = ownerNumber.includes(sender.id)
        const isBlocked = blockNumber.includes(sender.id)
        const isNsfw = isGroupMsg ? nsfw_.includes(chat.id) : false
        const uaOverride = 'WhatsApp/2.2029.4 Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_5) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/99.0.4844.51 Safari/537.36'
